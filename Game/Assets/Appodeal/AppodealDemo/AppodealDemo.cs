...
namespace AppodealAds.Unity.AppodealDemo
{
	...
	string appKey = "";
        ...
        private void OnGUI()
        {
            ...
            loggingToggle = GUI.Toggle(new Rect(Screen.width / 2, heightScale - Screen.height / 18, toggleSize * 3, toggleSize),
            ...
            if (GUI.Button(new Rect(widthScale, heightScale + 3 * heightScale, buttonWidth, buttonHeight),
                "SHOW BANNER",
                buttonStyle))
                showBanner();

            if (GUI.Button(new Rect(widthScale, heightScale + 4 * heightScale, buttonWidth, buttonHeight),
                "HIDE BANNER",
                buttonStyle))
                hideBanner();
            ...
            if (GUI.Button(new Rect(widthScale, heightScale + 7 * heightScale, buttonWidth, buttonHeight),
                "SHOW MREC VIEW",
                buttonStyle))
                showMrecView();

            if (GUI.Button(new Rect(widthScale, heightScale + 8 * heightScale, buttonWidth, buttonHeight),
                "HIDE MREC VIEW",
                buttonStyle))
                hideMrecView();

            if (GUI.Button(new Rect(widthScale, heightScale + 9 * heightScale, buttonWidth, buttonHeight),
                "UPDATE CONSENT",
                buttonStyle))
